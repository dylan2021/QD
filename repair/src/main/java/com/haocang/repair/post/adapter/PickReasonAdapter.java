package com.haocang.repair.post.adapter;
 ...
 * 修改时间：
 */
public class PickReasonAdapter extends BaseAdapter<LabelEntity> {

    public PickReasonAdapter(final int layoutId) {
        super(layoutId);
    }

    @Override
    protected void convert(final BaseHolder holder, final LabelEntity item) {
        if (item.isSelect()) {
