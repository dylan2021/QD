...
public class Constants {
    ...
    public static String getBaseFolder() {
        String baseFolder = Environment.getExternalStorageDirectory() + "/Mango/";
        File f = new File(baseFolder);
        if (!f.exists()) {
            boolean b = f.mkdirs();
            if (!b) {
                baseFolder = ctx.getExternalFilesDir(null).getAbsolutePath() + "/";
            }
        }
        return baseFolder;
    }
    ...
    public static Bitmap loadBitmapFromView(View contentLayout) {
