...
public class MagicHefeFilter extends GPUImageFilter {
    ...
    protected void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            public void run() {
                inputTextureHandles[0] = OpenGlUtils.loadTexture(Constants.ctx, "filter/edgeburn.png");
                inputTextureHandles[1] = OpenGlUtils.loadTexture(Constants.ctx, "filter/hefemap.png");
                inputTextureHandles[2] = OpenGlUtils.loadTexture(Constants.ctx, "filter/hefemetal.png");
                inputTextureHandles[3] = OpenGlUtils.loadTexture(Constants.ctx, "filter/hefesoftlight.png");
            }
        });
    }
}
