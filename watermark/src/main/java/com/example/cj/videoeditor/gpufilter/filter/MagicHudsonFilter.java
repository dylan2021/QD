...
public class MagicHudsonFilter extends GPUImageFilter {
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(Constants.ctx, "filter/hudsonbackground.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(Constants.ctx, "filter/overlaymap.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(Constants.ctx, "filter/hudsonmap.png");
		    }
	    });
	}
}
