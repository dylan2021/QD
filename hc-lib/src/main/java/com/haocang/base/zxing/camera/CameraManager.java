...
package com.haocang.base.zxing.camera;
...
import com.haocang.base.zxing.app.PreferencesActivity;
import com.haocang.base.zxing.decode.PlanarYUVLuminanceSource;
...
public final class CameraManager {
	...
	private static final int MIN_FRAME_WIDTH = (int) Util.dip2px(AppApplication.getContext(),180);
	private static final int MIN_FRAME_HEIGHT = (int) Util.dip2px(AppApplication.getContext(),180);
	private static final int MAX_FRAME_WIDTH = (int) Util.dip2px(AppApplication.getContext(),240);
	private static final int MAX_FRAME_HEIGHT = (int) Util.dip2px(AppApplication.getContext(),240);
