 ...
 * 修改时间：
 */
public class PickerViewNew extends RelativeLayout {

    /**
     * UI
     */
    private PickerItemViewNew pivYear;
    private PickerItemViewNew pivMonth;
    private PickerItemViewNew pivDay;
    ...
    public PickerViewNew(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public PickerViewNew(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context) {
        // 加载布局
        LayoutInflater.from(context).inflate(R.layout.layout_picker2, this);
        initView();
    }
...
//                tvMillisecond.setTextSize(size);
    ...
    private void onChange() {
        if (onPickerViewChangeListener != null) {
            onPickerViewChangeListener.onChange(PickerViewNew.this);
        }
    }
    ...
    private void initOnChange() {
        pivYear.setOnPitchOnChangeListener(new PickerItemViewNew.OnStringListener() {
            @Override
        ...
        pivMonth.setOnPitchOnChangeListener(new PickerItemViewNew.OnStringListener() {
            @Override
            public void onClick(String str) {
                try {
        ...
        pivDay.setOnPitchOnChangeListener(new PickerItemViewNew.OnStringListener() {
            @Override
            public void onClick(String str) {
                try {
    ...
    private void initPIV() {
        //年
        int year = Integer.parseInt(getDayStr(new Date()));
        years = new ArrayList<>();
    ...
    public interface OnPickerViewListener {
        void onChange(PickerViewNew pickerView);
    }
