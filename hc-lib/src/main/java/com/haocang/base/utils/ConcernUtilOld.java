...
public class ConcernUtilOld {
    ...
    public ConcernUtilOld setContexts(Context ctx) {
        this.ctx = ctx;
        return this;
    }
     ...
     * @return
     */
    public ConcernUtilOld setConcernId(int concernId) {
     ...
     * @return
     */
    public ConcernUtilOld setConcernType(String type) {
        concernType = type;
        return this;
    }


    public ConcernUtilOld setConcernSuccess(AddConcernInterface concernSucess) {
