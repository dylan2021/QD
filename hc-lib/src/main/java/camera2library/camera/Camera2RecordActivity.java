...
import camera2library.Camera2Config;
...
public class Camera2RecordActivity extends AppCompatActivity implements TextureView.SurfaceTextureListener {
    ...
    public static int RESULTCODE = 2009;
    //拍照方向
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    case CAPTURE_OK:
                        ...
                        intent.putExtra("picturePath", picSavePath);
    ...
    Runnable recordRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (MAX_RECORD_TIME - currentTime >= 0) {
    ...
    private void stopMediaRecorder() {
        ...
        try {
            ...
            if (currentTime <= MIN_RECORD_TIME) {
                ...
                Intent intent = new Intent();
                intent.putExtra("videoPath", videoSavePath);
                setResult(RESULTCODE, intent);
