...
import com.haocang.waterlink.follow.adapter.FollowRepairAdapter;
 ...
 * 修改时间：
 */
public class FollowRepairFragment extends Fragment implements BaseRefreshListener, FollowView {
    private FollowRepairAdapter adapter;
    ...
    private void initView(View view) {
        ...
        noDataTv.setText("暂无工单");
        frameLayout = view.findViewById(R.id.no_data_fl);
        recyclerView = view.findViewById(R.id.recyclerview);
        linearLayoutManager = new LinearLayoutManager(getActivity());
        recyclerView.setLayoutManager(linearLayoutManager);
        adapter = new FollowRepairAdapter(R.layout.adapter_follow_repair2, getActivity());
        ...
        adapter.setOnItemClickListener(new BaseAdapter.OnItemClickListener() {
            ...
            public void onClick(View view, int i, Object o) {
                ...
                intent.putExtra("repairId", entity.getItemId() + "");
    ...
    private int getScollYDistance() {
        ...
        if (firstVisiableChildView != null) {
            ...
            return (position) * 1 - firstVisiableChildView.getTop();
        }
        return itemHeight;
    }
