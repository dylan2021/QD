...
import com.haocang.waterlink.follow.adapter.FollowPatrolAdapter;
 ...
 * 修改时间：
 */
public class FollowPatrolFragment extends Fragment implements FollowView, BaseRefreshListener {
    private RecyclerView recyclerView;
    private FollowPatrolAdapter adapter;
    ...
    private void initView(View view) {
        ...
        adapter = new FollowPatrolAdapter(R.layout.adapter_follow_patrol, getActivity());
        ...
        adapter.setOnItemClickListener(new BaseAdapter.OnItemClickListener() {
            ...
            public void onClick(View view, int i, Object o) {
                isOutside((FolloContentEntity) o);
            }
    ...
    private void isOutside(final FolloContentEntity taskEntity) {
        Intent intent = new Intent(getActivity(), CommonActivity.class);
        intent.putExtra("taskId", taskEntity.getItemId());
        intent.putExtra("taskName", taskEntity.getName());
        if ("Outside".equals(taskEntity.getType())) {
