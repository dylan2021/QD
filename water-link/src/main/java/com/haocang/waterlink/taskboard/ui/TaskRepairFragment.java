...
import com.haocang.waterlink.taskboard.adapter.TaskBoardRepairAdapter;
 ...
 * 修改时间：
 */
public class TaskRepairFragment extends Fragment implements BaseRefreshListener, TaskBooardView {
    ...
    private TaskBoardRepairAdapter adapter;
    ...
    private void initView(View view) {
        ...
        adapter = new TaskBoardRepairAdapter(R.layout.adapter_task_board_third);
