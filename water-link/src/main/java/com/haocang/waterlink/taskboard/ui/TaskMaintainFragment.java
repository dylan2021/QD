...
import com.haocang.waterlink.taskboard.adapter.TaskBoardMaintainAdapter;
 ...
 * 修改时间：
 */
public class TaskMaintainFragment extends Fragment implements BaseRefreshListener, TaskBooardView {
    ...
    private TaskBoardMaintainAdapter adapter;
    ...
    private void initView(View view) {
        ...
        adapter = new TaskBoardMaintainAdapter(R.layout.adapter_task_board_four);
...
//            intent.putExtra("contentsItemsAll", bean.getContentsItemsAll());
//            intent.putExtra("contentsItemsFinished", bean.getContentsItemsFinished());
                intent.putExtra("state", taskEntity.getStatus());
                intent.putExtra("executeUserId", AppApplication.getInstance().getUserEntity().getId() + "");
