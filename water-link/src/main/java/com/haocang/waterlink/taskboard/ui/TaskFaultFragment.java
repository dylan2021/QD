...
import com.haocang.waterlink.taskboard.adapter.TaskBoardFaultAdapter;
 ...
 * 修改时间：
 */
public class TaskFaultFragment extends Fragment implements BaseRefreshListener, TaskBooardView {
    ...
    private TaskBoardFaultAdapter adapter;
    ...
    private void initView(View view) {
        ...
        adapter = new TaskBoardFaultAdapter(R.layout.adapter_task_board_second);
