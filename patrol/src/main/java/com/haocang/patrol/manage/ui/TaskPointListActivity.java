...
//设备下的测点列表
public class TaskPointListActivity extends BaseActivity {

    private int id;
    private Intent i;
    private boolean isTypeBZ, isShowWarm;
    private TaskPointListActivity context;
    ...
    private void initView() {
        ...
        adapter = new TaskListAdapter(R.layout.item_task_list, 1);
        ...
        adapter.setOnItemClickListener(new BaseAdapter.OnItemClickListener() {
            ...
            public void onClick(View view, int position, Object i) {
                ...
                Intent intent = new Intent(context, TaskPointDetailActivity.class);
                intent.putExtra("id", item.getExecutorId());
                intent.putExtra("title", item.getName());
                intent.putExtra("msg", item.getExecutorName());
